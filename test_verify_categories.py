...
class VerifyCategories(unittest.TestCase):
    ...
    def test_verify_categories(self):
        ...
        self.assertTrue(self.is_element_present(By.XPATH, "//nav[@id='site-menu']/ul/li[2]/a[@href='http://demo.litecart.net/en/rubber-ducks-c-1/']"))
        ...
        self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "li.product img"))
        driver.find_element_by_link_text("This n' that").click()
        self.assertFalse(self.is_element_present(By.CSS_SELECTOR, "li.product img"))
